...
grep -Fq 'ip saddr 10.77.0.110 ip daddr 10.77.0.1 tcp dport 3129 accept' <<<"${proxy_output}"
grep -Fq 'ip saddr 10.77.0.110 ip daddr 10.77.0.1 tcp dport 3128 drop' <<<"${proxy_output}"
grep -Fq 'ip saddr 10.77.0.12 ip daddr 10.77.0.1 tcp dport 3128 accept' <<<"${proxy_output}"
